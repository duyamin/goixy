...
all:
	...
	GOOS=linux GOARCH=386 go build -o goixy-linux-32
	GOOS=linux GOARCH=amd64 go build -o goixy-linux-64
	GOOS=linux GOARCH=arm go build -o goixy-arm-32
	GOOS=linux GOARCH=arm64 go build -o goixy-arm-64
